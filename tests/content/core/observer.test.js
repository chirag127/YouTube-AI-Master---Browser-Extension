...
describe('observer', () => {
  ...
  beforeEach(async () => {
    ...
    mockInjectWidget = vi.mocked(
      await import('../../../extension/content/ui/widget.js')
    ).injectWidget;
    mockIsWidgetProperlyVisible = vi.mocked(
    ...
    mockStartAnalysis = vi.mocked(
      await import('../../../extension/content/core/analyzer.js')
    ).startAnalysis;
