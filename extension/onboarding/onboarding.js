...
class OnboardingFlow {
  ...
  setupEventListeners() {
    ...
    ge('toggleApiKeyBtn') &&
      on(ge('toggleApiKeyBtn'), 'click', this.toggleApiKeyVisibility.bind(this));
