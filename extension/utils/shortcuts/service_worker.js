...
export const cr = () => self.registration;
export const cu = () => self.registration.update();
export const un = () => self.registration.unregister();
export const sn = () => self.registration.showNotification();
export const gn = () => self.registration.getNotifications();
